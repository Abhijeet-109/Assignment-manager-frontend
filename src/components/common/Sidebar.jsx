...
const navItems = {
    ...
    teacher: [
        ...
        { label: 'Assignments', to: '/teacher/assignments', d: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z' },
    ],
    student: [
        ...
        { label: 'My Uploads', to: '/student/uploads', d: 'M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z' },
    ],
};
